 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simulationanswer_question_test extends UnitTestCase {
    public function test_compare_string_with_wildcard() {
        // Test case sensitive literal matches.
        $this->assertTrue(qtype_simulationanswer_question::compare_string_with_wildcard(
                'Frog', 'Frog', false));
        $this->assertFalse(qtype_simulationanswer_question::compare_string_with_wildcard(
                'Frog', 'frog', false));
        $this->assertTrue(qtype_simulationanswer_question::compare_string_with_wildcard(
                '   Frog   ', 'Frog', false));
        $this->assertFalse(qtype_simulationanswer_question::compare_string_with_wildcard(
    ...
    public function test_is_complete_response() {
        $question = test_question_maker::make_a_simulationanswer_question();
    ...
    public function test_get_question_summary() {
        $sa = test_question_maker::make_a_simulationanswer_question();
