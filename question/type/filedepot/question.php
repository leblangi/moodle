...
/**
 * Filedepot question definition class.
 *
 * @package    qtype
...
/**
 * Represents an filedepot question.
 *
 * @copyright &copy; 2012 Université de Montréal
 * @author gilles-philippe.leblanc@umontreal.ca
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_filedepot_question extends question_with_responses {
     ...
     * @return qtype_filedepot_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_filedepot', 'format_' . $this->responseformat);
    }
    ...
    public function get_expected_data() {
        ...
        if ($this->attachments != 0) {
			...
			echo question_attempt::PARAM_FILES;
        }
        return $expecteddata;
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_filedepot' && $filearea == 'graderinfo') {
            return $options->manualcomment;

        } else if ($component == 'qtype_filedepot' && $filearea == 'basefile') {
