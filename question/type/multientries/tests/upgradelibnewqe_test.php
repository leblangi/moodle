...
/**
 * Testing the upgrade of multientries question attempts.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multientries_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_multientries_deferredfeedback_history80() {
        $quiz = (object) array(
            'id' => '278',
            'course' => '2950',
            'name' => 'test quiz 1',
    ...
    public function test_multientries_deferredfeedback_history70() {
        $quiz = (object) array(
            'id' => '442',
            'course' => '2591',
    ...
    public function test_multientries_deferredfeedback_history0() {
        $quiz = (object) array(
            'id' => '466',
            'course' => '3464',
